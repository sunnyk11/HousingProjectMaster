...
namespace HousingProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    var users = db.Users.Where(x => x.Email == model.Email).FirstOrDefault();
                    if (users.UserType == 1)
                    {
                    ...
                    {
                        Session["UserId"] = users.Id.ToString();
                        return RedirectToAction("Index", "AssistantManager");
                    }
                    ...
                    else if (users.UserType == 4)
                    {
                        Session["UserId"] = users.Id.ToString();
                        return RedirectToAction("Index", "Lead");
                    }
                    else if (users.UserType == 5)
                    {
                        Session["UserId"] = users.Id.ToString();
        ...
        [AllowAnonymous]
        public ActionResult DealerRegister()
        {
            return View();
        }
